...
<form method="POST" action="{{ route('jobs.store') }}">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <input type="text" name="slug" class="form-control" value="{{ old('slug') }}" readonly>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <input type="number" name="min_experience_months" class="form-control" value="{{ old('min_experience_months', 0) }}" min="0">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <input type="number" name="salary_min" class="form-control" value="{{ old('salary_min') }}" step="0.01" min="0" id="salary_min">
        ...
        <div class="col-md-6">
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <input type="number" name="salary_max" class="form-control" value="{{ old('salary_max') }}" step="0.01" min="0" id="salary_max">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <input type="date" name="posting_date" class="form-control" value="{{ old('posting_date', date('Y-m-d')) }}" id="posting_date">
        ...
        <div class="col-md-6">
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <input type="date" name="last_apply_date" class="form-control" value="{{ old('last_apply_date') }}" id="last_apply_date">
                ...
                @foreach($skills as $skill)
                    <div class="skills-checkbox-item">
                        <input type="checkbox" name="skills[]" value="{{ $skill->id }}" id="skill_{{ $skill->id }}" 
                               {{ (collect(old('skills'))->contains($skill->id)) ? 'checked' : '' }}>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <textarea name="responsibilities" id="responsibilities" class="form-control" rows="4">{{ old('responsibilities') }}</textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Salary inputs found:', salaryMinInput, salaryMaxInput);
    
    function validateSalary() {
        const minSalary = parseFloat(salaryMinInput.value) || 0;
        const maxSalary = parseFloat(salaryMaxInput.value) || 0;
        
        if (minSalary > 0 && maxSalary > 0 && maxSalary < minSalary) {
            salaryMaxInput.setCustomValidity('Maximum salary must be greater than or equal to minimum salary.');
    ...
    const lastApplyDateInput = document.getElementById('last_apply_date');
    
    console.log('Date inputs found:', postingDateInput, lastApplyDateInput);
    
    function validateDates() {
        const postingDate = new Date(postingDateInput.value);
        const lastApplyDate = new Date(lastApplyDateInput.value);
        
        if (postingDateInput.value && lastApplyDateInput.value && lastApplyDate <= postingDate) {
            lastApplyDateInput.setCustomValidity('Last apply date must be after posting date.');
            lastApplyDateInput.reportValidity();
            return false;
        } else {
    ...
    postingDateInput.addEventListener('change', validateDates);
    lastApplyDateInput.addEventListener('change', validateDates);
