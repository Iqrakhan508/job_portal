...
<a href="{{route('add_company.create')}}" class="btn btn-w-m btn-primary mb-2"> Ads New Company </a>
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('add_company.edit', $company->id) }}">
                    <button class="btn btn-primary btn-sm">Edit</button>
                </a>

                <form action="{{ route('add_company.destroy', $company->id) }}" method="POST" style="display:inline-block;">
                    @csrf
                    @method('DELETE')
