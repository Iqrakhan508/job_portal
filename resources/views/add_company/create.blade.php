...
<form method="POST" action="{{ route('add_company.store') }}">
    @csrf
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <textarea name="code" class="form-control" rows="4" required>{{ old('code') }}</textarea>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <div class="form-check">
                <input type="checkbox" name="is_auto" value="1" class="form-check-input" id="is_auto" {{ old('is_auto') == '1' ? 'checked' : '' }}>
